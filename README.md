...
ZID_EXCLUDED_STATUSES=returned,returning,return requested,return_in_progress,reverse,reverse pickup,refund,refunded,exchange,exchanged,استرجاع,ارجاع,إرجاع,مرتجع,مسترجع,جاري الاسترجاع,جارى الاسترجاع,قيد الاسترجاع,تحت الاسترجاع,تم الاسترجاع,طلب استرجاع,استبدال,مستبدل
ZID_SYNC_INCLUDE_DAYS=2
